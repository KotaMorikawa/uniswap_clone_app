...
const style = {
    ...
    navItem: `p-4 py-2 m-1 flex items-center text-lg font-semibold cursor-pointer rounded-3xl`,
    ...
    buttonAccent: `bg-[#172A42] border border-[#163256] hover:border-[#234169] h-full rounded-2xl flex items-center justifycenter text-[#4F90EA]`,
}
...
const Header = () => {
    ...
    useEffect(() => {
        if (currentAccount) {
            setUserName(`${currentAccount.slice(0,7)}...${currentAccount.slice(35)}`, [currentAccount])
        }
    })
